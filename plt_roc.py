...
if __name__ == '__main__':
    ...
    parser_.add_argument('--auc_path', type=str,default='output/clfResult/resnet/auc.npy')
    parser_.add_argument('--roc_path', type=str,default='output/clfResult/resnet/roc.npy')
    parser_.add_argument('--save_pic_dir', type=str, default='./output/clfResult/resnet/ROC.jpg')
