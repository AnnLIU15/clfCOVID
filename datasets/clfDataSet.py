...
class clfDataSet(Dataset):
    ...
    def __getitem__(self, idx):
        ...
        if self.match:
            ...
            radiomics_data=torch.zeros(size=(self.radiomics_feature[0],self.radiomics_feature[1])).squeeze().float()
    ...
    def __get_dataset_match(self):
        ...
        radiomics_name=[var[len(radiomics_path_dir)+1:-4] for var in radiomics_path]
        if self.match:
            sum_of_error=0
            try:
